...
class StepAudioTTS:
    ...
    def offload_to_cpu(self):
        ...
        # 卸载 CosyVoice 模型
        if hasattr(self, 'cosy_model') and self.cosy_model is not None:
            if hasattr(self.cosy_model, 'model') and hasattr(self.cosy_model.model, 'llm'):
                self.cosy_model.model.llm = self.cosy_model.model.llm.to('cpu')
            if hasattr(self.cosy_model, 'model') and hasattr(self.cosy_model.model, 'flow'):
                self.cosy_model.model.flow = self.cosy_model.model.flow.to('cpu')
            if hasattr(self.cosy_model, 'model') and hasattr(self.cosy_model.model, 'hift'):
        ...
        if hasattr(self, 'audio_tokenizer') and self.audio_tokenizer is not None:
            if hasattr(self.audio_tokenizer, 'offload_to_cpu'):
    ...
    def load_to_gpu(self):
        ...
        if hasattr(self, 'cosy_model') and self.cosy_model is not None:
            if hasattr(self.cosy_model, 'model') and hasattr(self.cosy_model.model, 'llm'):
                self.cosy_model.model.llm = self.cosy_model.model.llm.to('cuda')
            if hasattr(self.cosy_model, 'model') and hasattr(self.cosy_model.model, 'flow'):
                self.cosy_model.model.flow = self.cosy_model.model.flow.to('cuda')
            if hasattr(self.cosy_model, 'model') and hasattr(self.cosy_model.model, 'hift'):
                self.cosy_model.model.hift = self.cosy_model.model.hift.to('cuda')
        # 加载 Tokenizer (FunASR)
        if hasattr(self, 'audio_tokenizer') and self.audio_tokenizer is not None:
            if hasattr(self.audio_tokenizer, 'load_to_gpu'):
                self.audio_tokenizer.load_to_gpu()
